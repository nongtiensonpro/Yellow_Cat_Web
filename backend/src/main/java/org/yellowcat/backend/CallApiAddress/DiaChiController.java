...
public class DiaChiController {
    ...
    @GetMapping("/provinces")
    public List<TinhDTO> getAllProvinces() {
        return diaChiService.getAllTinh();
    }

    @GetMapping("/provinces/{provinceCode}/districts")
    public List<HuyenDTO> getDistrictsByProvince(@PathVariable String provinceCode) {
        return diaChiService.getHuyenByTinhCode(provinceCode);
    }

    @GetMapping("/districts/{districtCode}/wards")
    public List<XaDTO> getWardsByDistrict(@PathVariable String districtCode) {
        return diaChiService.getXaByHuyenCode(districtCode);
    }
}
