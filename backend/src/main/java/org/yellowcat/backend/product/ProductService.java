package org.yellowcat.backend.product;//package org.yellowcat.backend.product;
//
...
import org.springframework.security.oauth2.jwt.Jwt;
import org.springframework.stereotype.Service;
import org.yellowcat.backend.product.ProductHistoryRepository;
...
public class ProductService {
    ...
    public List<ProductBestSellerCustomDTO> getBestSellingProductsCustom(String startDate, String endDate) {
        // Gọi phương thức repository mới để lấy dữ liệu
        return productRepository.findBestSellingProductsByDateRange(startDate, endDate);
    }
