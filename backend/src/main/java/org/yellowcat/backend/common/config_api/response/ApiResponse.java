...
public class ApiResponse<T> {
    private LocalDateTime timestamp;
    private int status;
    private boolean success; // <--- DÒNG NÀY ĐƯỢC THÊM VÀO
    private String message;
    private T data;
    private String error;
    private String path;
    ...
    public ApiResponse(HttpStatus status, String message, T data) {
        this();
        this.status = status.value();
        this.success = true; // <--- DÒNG NÀY ĐƯỢC THÊM VÀO
        this.message = message;
        this.data = data;
    }
    ...
    public ApiResponse(HttpStatus status, String message, String error) {
        this();
        this.status = status.value();
        this.success = false; // <--- DÒNG NÀY ĐƯỢC THÊM VÀO
        this.message = message;
        this.error = error;
    }
    ...
    // Getter và Setter cho trường success mới
    public boolean isSuccess() { // <--- DÒNG NÀY ĐƯỢC THÊM VÀO
        return success;
    }

    public void setSuccess(boolean success) { // <--- DÒNG NÀY ĐƯỢC THÊM VÀO
