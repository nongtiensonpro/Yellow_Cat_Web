...
//
// import {
//     Card, CardHeader, CardBody, Divider, Table, TableHeader, TableColumn, TableBody, TableRow, TableCell,
...
//
//     const handleConfirm = () => {
//         const errMsg = validateMaterialName(formData.name, materials, "add");
//         if (errMsg) {
//             setError(errMsg);
//             return;
//         }
...
//             <ModalContent>
//                 <ModalHeader>Thêm chất liệu</ModalHeader>
//                 <ModalBody>
//                     <Input
//                         label="Tên chất liệu"
//                         name="name"
...
//                 <ModalFooter>
//                     <Button variant="light" onClick={onClose}>Huỷ</Button>
//                     <Button color="primary" onClick={handleConfirm} isLoading={isSubmitting}>Thêm mới</Button>
//                 </ModalFooter>
//             </ModalContent>
//         </Modal>
//     );
...
//         const validationError = validateMaterialName(
//             trimmedName,
//             materials,
//             modalMode!,
//             selected?.id
...
//
//                 <div className="flex justify-center items-center gap-4 mt-6">
//                     <Button onClick={() => setCurrentPage((prev) => Math.max(prev - 1, 0))} isDisabled={currentPage === 0} variant="flat">
//                         Trước
//                     </Button>
//                     <span className="text-gray-700 dark:text-gray-300">
//             Trang {totalPages === 0 ? 0 : currentPage + 1} / {totalPages}
//           </span>
//                     <Button onClick={() => setCurrentPage((prev) => Math.min(prev + 1, totalPages - 1))} isDisabled={currentPage >= totalPages - 1} variant="flat">
//                         Sau
//                     </Button>
//                 </div>
//             </CardBody>
...
//                     <ModalContent>
//                         <ModalHeader>
//                             {modalMode === 'edit' ? 'Cập nhật chất liệu' : 'Xác nhận xoá chất liệu'}
//                         </ModalHeader>
//                         <ModalBody>
//                             {modalMode === 'delete' ? (
//                                 <p className="text-gray-700 dark:text-gray-300">
...
//                             ) : (
//                                 <Button color="primary" onClick={handleSubmit} isLoading={isSubmitting}>Cập nhật</Button>
//                             )}
//                         </ModalFooter>
//                     </ModalContent>
//                 </Modal>
