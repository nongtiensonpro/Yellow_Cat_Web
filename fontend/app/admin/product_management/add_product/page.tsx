...
export default function AddProductPage() {
    ...
    const generateVariantsMatrix = () => {
        ...
        if (!validatePriceWithToast(bulkSettings.price, bulkSettings.price)) {
        ...
        selectedColors.forEach(colorId => {
            selectedSizes.forEach(sizeId => {
                const variant: ProductVariant = {
                    ...
                    enabled: true,
                    costPrice: bulkSettings.costPrice // Giá nhập
                };
        ...
        setFormData(prev => ({
            ...
            variants: prev.variants.map(v =>
                v.enabled ? {
                    ...
                    costPrice: bulkSettings.costPrice !== undefined ? bulkSettings.costPrice : v.costPrice
                } : v
            )
        }));
