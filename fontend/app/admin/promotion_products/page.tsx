...
//                 <h2 className="text-xl font-semibold text-gray-800">Đợt giảm giá</h2>
//                 <Link
...
//                         onChange={(e) =>
//                             setFilters({ ...filters, discountType: e.target.value, discountValue: '' })
//                         }
//                     >
...
//                         <th className="px-4 py-3 border">Thời gian bắt đầu</th>
//                         <th className="px-4 py-3 border">Thời gian kết thúc</th>
...
//                                 <td className="px-4 py-2 border text-center">
//                                     <Link
//                                         href={`/admin/promotion-management/${promo.id}`}
