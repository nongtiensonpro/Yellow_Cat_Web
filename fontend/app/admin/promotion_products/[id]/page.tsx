...
import { Session } from 'next-auth';
import axios, { AxiosError } from 'axios';
// Import các component cần thiết từ @heroui/react
import { addToast, Table, TableHeader, TableColumn, TableBody, TableRow, TableCell} from "@heroui/react";
        ...
        try {
            ...
            if (err instanceof AxiosError) {
                ...
                if (msg.toLowerCase().includes('tồn tại')) {
                    ...
                    setConflictMessage(msg); // Lưu tin nhắn lỗi
                    addToast({
                        ...
                        actions: [{
                            text: 'Xem chi tiết',
                            onClick: () => {
                                setIsConflictDialogOpen(true); // Mở dialog
                            },
                        }],
                        variant: 'warning',
                        duration: 8000,
