...
export default function CreatePromotionPage() {
    ...
    const handleChange = (
        ...
        if (name === 'discountValue') {
            ...
            newFormState.discountValue = value === '' ? 0 : parseInt(value, 10);
        ...
        const priceError = validateDiscountAgainstPrice(newFormState.discountType, newFormState.discountValue, details);
    ...
    const handleSelectAllDetails = (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        if (isChecked) {
            setSelectedVariants(prev => [...new Set([...prev, ...detailIdsOnPage])]);
        } else {
