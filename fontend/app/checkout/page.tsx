...
// // import { CldImage } from 'next-cloudinary'; // Uncomment if you want to use CldImage for product images
//
// // Re-define CartItem interface if not already globally available or in a shared types file
// interface CartItem {
//     id: number;
//     productId: number;
//     productName: string;
...
//     const [cartItems, setCartItems] = useState<CartItem[]>([]); // State to store dynamic cart items
//     const [loadingCart, setLoadingCart] = useState(true); // New loading state for cart
//
//     useEffect(() => {
...
//             }
//         }
//         setLoadingCart(false); // Set loading to false once cart is fetched
//     }, []);
//
...
//     };
//
//     // --- Dynamic values based on cart items ---
//     const totalBeforeDiscount = calculateSubtotal();
//     // For demonstration, let's assume shipping and discount logic is applied here
//     // In a real app, these would come from an API based on cart contents, user address, etc.
//     const shippingFee = totalBeforeDiscount > 0 ? 54000 : 0; // Example: 54k if there are items, else 0
//     const discount = totalBeforeDiscount > 500000 ? 100000 : 0; // Example: 100k discount if total > 500k
//     const finalTotal = totalBeforeDiscount + shippingFee - discount;
//
//
//     if (loadingCart) {
//         return (
...
//             <h1 className="text-3xl font-bold mb-6 text-gray-800">THÔNG TIN</h1>
//
...
//                                 <select id="province" className="p-3 border border-gray-300 rounded-md w-full focus:ring-blue-500 focus:border-blue-500">
...
//                                 <select id="district" className="p-3 border border-gray-300 rounded-md w-full focus:ring-blue-500 focus:border-blue-500">
...
//                                 <select id="ward" className="p-3 border border-gray-300 rounded-md w-full focus:ring-blue-500 focus:border-blue-500">
//                                     <option value="">Chọn Xã/Phường</option>
//                                     <option>Phường Hàng Bồ</option>
//                                     <option>Phường Tràng Tiền</option>
//                                     {/* Add more options dynamically */}
//                                 </select>
//                             </div>
//                             <div>
...
//                                     type="text"
//                                     id="addressDetail"
//                                     placeholder="Số nhà, tên đường" // More generic placeholder
//                                     className="p-3 border border-gray-300 rounded-md w-full focus:ring-blue-500 focus:border-blue-500"
//                                 />
//                             </div>
...
//                             />
//                             <div className="ml-3 text-gray-700 font-medium flex items-center">
//                                 {/* You might need to add a local image for VNPay */}
...
//                                     {item.imageUrl ? (
//                                         // If you have CldImage configured, use it here
//                                         // <CldImage
//                                         //     src={item.imageUrl}
//                                         //     alt={item.name}
//                                         //     width={80}
...
//                                         // />
//                                         <img
//                                             src={item.imageUrl} // Use direct img tag if CldImage is not preferred or configured
//                                             alt={item.name}
//                                             width={80}
//                                             height={80}
//                                             className="rounded-md object-cover mr-4"
...
//                                         {/* Assuming 'productName' might be a broader name and 'name' is specific variant */}
//                                         {item.productName !== item.name && (
//                                             <p className="text-sm text-gray-600">{item.productName}</p>
//                                         )}
//                                         <p className="text-sm text-gray-600">Số lượng: {item.quantity}</p>
//                                         <p className="text-lg font-bold text-red-600 mt-1">{formatPrice(item.price * item.quantity)}</p>
//                                     </div>
//                                 </div>
//                             ))}
//
//                             <h2 className="text-xl font-bold mb-4 text-gray-800">Tổng tiền: {formatPrice(totalBeforeDiscount)}</h2>
//                         </>
//                     )}
//
