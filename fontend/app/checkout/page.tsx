...
//     useEffect(() => {
//         if (!selectedProvinceCode) {
//             setDistricts([]); setSelectedDistrictCode(null); return;
//         }
//         setLoadingDistricts(true);
...
//     useEffect(() => {
//         if (!selectedDistrictCode) {
//             setWards([]); setSelectedWardCode(null); return;
//         }
//         setLoadingWards(true);
...
//                     <ModalHeader>Chọn địa chỉ giao hàng</ModalHeader>
//                     <ModalBody>
//                         {userAddresses.length === 0 ? <div className="text-center py-8 text-gray-400">Bạn chưa có địa chỉ nào.</div> :
//                             <div className="space-y-4">
//                                 {userAddresses.map((address, idx) => (
//                                     <div key={address.addressId || idx} className="border border-gray-200 rounded-lg p-4 flex flex-col md:flex-row md:items-center md:justify-between cursor-pointer hover:border-blue-500 transition-all" onClick={() => handleSelectAddress(address)}>
//                                         <div>
//                                             <div className="font-semibold text-gray-900">{address.recipientName}</div>
//                                             <div className="text-sm text-gray-500">{address.phoneNumber}</div>
//                                             <div className="text-sm text-gray-500">{address.streetAddress}, {address.wardCommune}, {address.district}, {address.province || address.cityProvince}</div>
//                                         </div>
//                                         <Button size="sm" className="mt-2 md:mt-0" onClick={() => handleSelectAddress(address)}>Chọn</Button>
//                                     </div>
//                                 ))}
//                             </div>
//                         }
