...
interface Product {
    ...
    minSalePrice: number | null; // Bỏ optional vì backend luôn trả về field này (có thể null)
...
const ProductList = () => {
    ...
    const calculateDiscountPercent = (price: number | null, salePrice: number | null) => {
        // Kiểm tra null và đảm bảo salePrice < price
            ...
            >
                ...
                <CardBody className="px-4 py-3">
                    ...
                    <div className="flex items-center gap-2 my-2">
                        ...
                        {/* Hiển thị giá gốc gạch ngang và giá sale nếu có promotion active */}
                        {product.minSalePrice && product.minPrice && product.minSalePrice < product.minPrice ? (
                            ...
                            /* Hiển thị giá gốc nếu không có promotion hoặc promotion hết hạn */
