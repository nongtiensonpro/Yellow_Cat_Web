...
// //
// //     return (
// //         <HeroUINavbar maxWidth="full" position="static" isMenuOpen={isMenuOpen} onMenuOpenChange={setIsMenuOpen} className="py-4">
...
// //                     <NavbarItem>
// //                         <NextLink
// //                             className={clsx(linkBaseClass, pathname.startsWith("/products") ? activeLinkClass : inactiveLinkClass, "flex items-center gap-1")}
// //                             href="/products"
// //                         >
// //                             Sản phẩm
// //                         </NextLink>
...
// //                     <NavbarItem>
// //                         <NextLink
// //                             className={clsx(linkBaseClass, pathname.startsWith("/about") ? activeLinkClass : inactiveLinkClass)}
// //                             href="/about"
// //                         >
// //                             Giới thiệu
// //                         </NextLink>
...
// //                     <NavbarItem>
// //                         <NextLink
// //                             className={clsx(linkBaseClass, pathname.startsWith("/contact") ? activeLinkClass : inactiveLinkClass)}
// //                             href="/contact"
// //                         >
// //                             Liên hệ
// //                         </NextLink>
...
// //                     </NavbarMenuItem>
// //                     <NavbarMenuItem>
// //                         <Link className={clsx("text-foreground", pathname.startsWith("/products") && "font-semibold text-orange-500")} href="/products" size="lg">Sản phẩm</Link>
// //                     </NavbarMenuItem>
// //                     <NavbarMenuItem>
// //                         <Link className={clsx("text-foreground", pathname.startsWith("/about") && "font-semibold text-orange-500")} href="/about" size="lg">Giới thiệu</Link>
// //                     </NavbarMenuItem>
// //                     <NavbarMenuItem>
// //                         <Link className={clsx("text-foreground", pathname.startsWith("/contact") && "font-semibold text-orange-500")} href="/contact" size="lg">Liên hệ</Link>
// //                     </NavbarMenuItem>
// //                     {isAdmin && (
// //                         <NavbarMenuItem>
// //                             <Link className={clsx("text-foreground", pathname.startsWith("/admin") && "font-semibold text-orange-500")} href="/admin" size="lg">Admin Dashboard</Link>
// //                         </NavbarMenuItem>
// //                     )}
// //                     <NavbarMenuItem>
// //                         {renderAuthSection()}
